...
let texture = new THREE.TextureLoader().load( 'textures/oldbrick.jpg' );
let TextureGrass = new THREE.TextureLoader().load( 'textures/newgrass.jpg' );
let textureGate = new THREE.TextureLoader().load( 'textures/newgate.jpg');
